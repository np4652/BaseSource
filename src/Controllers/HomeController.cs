...
namespace BaseSource.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IDapper dapper, IBL bl)
        {
            _logger = logger;
            _dapper = dapper;
        ...
        //public async Task<IActionResult> PostDataAsyncOld(string _namespace, string name, List<string> head, List<string> body, string apiKey)
        //{
        //    var result = new List<MessageResponseList>();
        ...
        //public async Task<IActionResult> PostAlternateDataAsyncOld(string _namespace, string name, List<string> head, List<string> body, string apiKey)
        //{
        //    var result = new List<MessageResponseList>();
